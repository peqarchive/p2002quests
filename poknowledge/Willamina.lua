function event_say(e)
		if(e.message:findi("hail")) then
			e.self:Say("Hello and good morning " .. e.other:GetName().. " It's such a lovely day to sit and enjoy the beautiful surroundings. is it not?  I do hope you find what you are looking for here. Not all of us have been so successful in our individual [" .. eq.say_link("quests") .. "] the shroud.");
		elseif(e.message:findi("quests")) then
			e.self:Say("The city is full of curious people all searching for something. Many have struggled for a long time to find their reward. Some are not even aware of what is it they are looking for, but will know it when they see it. Would you care to [" .. eq.say_link("help") .. "] me out? It will only take a moment.");
