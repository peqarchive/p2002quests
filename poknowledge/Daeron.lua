...
function event_say(e)
	...
	elseif (e.message:findi("retrieve")) then
		e.other:Message(15,"The first is located at the ruins on the island within Dagnors Cauldron.  For the next one, search the book case in the abandoned temple within the dreadlands.  Lastly, inspect the orb that leads to Crystal Caverns in the Eastern Wastes, I suspect you will find another one there.");	
