function event_say(e)
	...
	elseif(fac < 4) then
		if(e.message:findi("treant fists")) then
			e.self:Say("You desire the treant fists?  I have them and I will offer them to any [" .. eq.say_link("skilled monk of the Ashen House") .. "].");
		...
		elseif(e.message:findi("skilled monk of the Ashen House")) then
			e.self:Say("Then you shall aid our family. My former pupil [" .. eq.say_link("Who is Clawfist",false,"Clawfist") .. "] has been [" .. eq.say_link("Where is Clawfist",false,"banished") .. "] by his people. You will go to him and hand him this token as proof of your origin. He shall be expecting you.");
