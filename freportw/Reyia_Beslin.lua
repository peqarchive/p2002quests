function event_say(e)
	...
	elseif e.other:GetFaction(e.self) < 4 then
		if(e.message:findi("orange sash")) then
	...
	elseif e.message:findi("orange sash") or e.message:findi("red sash") then
...
function event_trade(e)
	...
	if e.other:GetFaction(e.self) < 4 then
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13237,item2 = 13238,item3 = 10132})) then
			...
			e.other:Faction(12,75,0); -- Ashen Order
			e.other:Faction(184,11,0); -- Knights of Truth
