function event_say(e)
	...
	elseif(e.message:findi("repair the toupee")) then
		e.self:Say("Ah!! You have a toupee to repair. It must be the [" .. eq.say_link("What is the Mane Attraction",false,"Mane Attraction") .. "]. I gave a one out and it seems to always fall to pieces. Seeing as it has a 100 season warranty and I only created it 5 seasons ago, I suppose I can do it. Do you want me to [" .. eq.say_link("make the Mane Attraction") .. "].");
