function event_say(e)
	...
	elseif(e.other:Class() == "Paladin") then
		if(e.message:findi("water")) then
			e.self:Say("Aye, water, m'lord. For my brother. He is very sick. He's needin' drink. He's burnin' up. I am sick myself but still able to move, a little. I must [" .. eq.say_link("I will take it",false,"take this water to him") .. "] before he gets worse.");
