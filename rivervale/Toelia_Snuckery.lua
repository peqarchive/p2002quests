...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13785})) then
		e.self:Say("What is this?  The pouch is empty!  Where is the Ruby?!  What do you mean you don't have it?  Oh no.  I bet [" .. eq.say_link("Chomper") .. "] swallowed it!  Get it back and bring it to me.");
		e.other:Ding();
