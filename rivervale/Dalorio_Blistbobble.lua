...
function event_trade(e)
	...
	if (item_lib.check_turn_in(e.self, e.trade, {item1 = 22940, item2 = 22941, item3 = 22942, item4 = 22943})) then -- War Documents pg1, War Documents pg2, War Documents pg3 and War Documents pg4
		...
		e.other:QuestReward(e.self,0,0,0,0,22945,500); -- Edge of the Proudfoot
	else
