function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("It is a pleasure to meet you " .. e.other:GetName() .. ". I am Thekela Meepup. one of the highest ranking Clerics in all of Rivervale. I pride myself on being the mentor for all of the furryfooted that are called upon by Bristlebane to give life. If you are a [" .. eq.say_link("Cleric") .. "] I might have some training for you to complete if you so wish.");
	elseif(e.message:findi("cleric")) then
		e.self:Say("" .. e.other:GetName() .. " the Templar. Well I suppose that does have quite a nice ring to it don't you say? If you stick with your training perhaps this could be what you are referred to one day. Before that day though. you have a lot to learn and a lot of training ahead of you! Do you want to [" .. eq.say_link("begin your training") .. "] at this time?");
	elseif(e.message:findi("begin my training")) then
		e.self:Say("Excellent! I will give you a variety of items to collect and combine in this magical assembly kit to create a material that you will use to craft armor. My hope is that as you gather these items you will learn about your home and how to navigate around the surrounding areas of the Vale. If you are ready to begin your adventure I will present you with your Magical Mail Assembly Kit and the instructions for collecting the necessary items to craft your armor. Are you [" .. eq.say_link("ready to receive your Magical Mail Assembly Kit") .. "]?");
	elseif(e.message:findi("ready to receive my magical mail assembly kit")) then
		e.self:Say("Here you are " .. e.other:GetName() .. ". Take this mail assembly kit. it is what you will use to combine the different items necessary to craft your own Platemail of the Stoutdeacon. Different combinations of items will be required from both our town and the hunting grounds in the thicket to create materials for specific armor pieces with Crude Iron Ore being the basis for all of your armor materials. When you are ready to receive a recipe for a specific material simply tell me what armor piece you [" .. eq.say_link("want") .. "] to craft. I will then supply you with the mold and recipe for Stoutdeacon Platemail [" .. eq.say_link("Helms") .. "], [" .. eq.say_link("Bracers") .. "], [" .. eq.say_link("Boots") .. "],  [" .. eq.say_link("Armguards") .. "]");
		e.self:Say("[" .. eq.say_link("Greaves") .. "], [" .. eq.say_link("Gauntlets") .. "] and [" .. eq.say_link("Breastplates") .. "].");
	...
	elseif(e.message:findi("breastplate")) then
		e.self:Say("So the time has finally come for you to create your final piece of armor I see " .. e.other:GetName() .. ". Seek out 5 Bricks of Crude Iron Ore. 1 Deathfist Slashed Belt. 1 Giant Yellowjacket Sternites. 2 Dark Elf Skins and 1 Undamaged Mossy Rat Pelt then combine them in your kit. Take that material along with this mold to the nearest forge and reap the rewards of your hard work. Come back to see me when you are finished because I have a [" .. eq.say_link("special task") .. "] for you.");
		e.other:SummonItem(22616);
	elseif(e.message:findi("special task")) then
		e.self:Say("If you are asking me about this special task that I need completed then you surely must have completed all the steps necessary to prove yourself as a worthy servant of Bristlebane. Going forward I will need you to gather some [" .. eq.say_link("research annals") .. "] from a Muddite in the Gorge of King Xorbb that stole them from me.");
	elseif(e.message:findi("research annal")) then
		e.self:Say("The research annals that I need you to retrieve are very important ones to me. King Tearis Thex of Felwithe presented them to me for study. He entrusted me with them because he felt I could benefit from the knowledge that they contained. Will you [" .. eq.say_link("seek out my annals ") .. "]?");
