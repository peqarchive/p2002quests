...
function event_say(e)
	...
	elseif(e.message:findi("temple of life")) then
		e.self:Say("Oh, yes.. They always come for Kizzie's [" .. eq.say_link("honey jum") .. "]. They should have sent you next week. There is a [" .. eq.say_link("problem") .. "].");
	elseif(e.message:findi("problem")) then
		e.self:Say("You see.. Joogl Honeybugger is hurt. He usually collects the [" .. eq.say_link("Honeycombs") .. "]. Only he knows where to get them. I need the Honeycombs to make the Honey Jum. Go and speak with Joogl. He is at his burrow outside of Rivervale. He says he cannot work. Tell him you need the Honeycombs.");
	...
	elseif(e.message:findi("honey jum")) then
		e.self:Say("It's a secret!!  I get the honeycombs and combine them with the secret sauce and..presto.. honey jum!!  It is used by only the wisest as a component.  And you can only get it from Kizzie.  It is also good on batwing crunchies.  If you like.. Kizzie can [" .. eq.say_link("make honey jum") .. "] for you?");
	end
end
