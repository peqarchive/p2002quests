function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings " .. e.other:GetName() .. ". It is my duty to teach young Fier`Dal the arts of defense and fighting so that they may become skilled members of the Emerald Warriors. There are many [" .. eq.say_link("threats") .. "] facing our forests and our home Kelethin, thus we warriors must be prepared both physically and mentally to defend our people. It is wise for all young Emerald Warriors to acquire a [" .. eq.say_link("suit of armor") .. "] to protect them from the weapons of our enemies.");
	elseif(e.message:findi("suit of armor")) then
		e.self:Say("You will require this specially prepared Mail Assembly Kit to assemble a suit of Emerald Novice Armor. The required materials vary depending on the piece of armor you seek to craft. Once you have been properly outfitted return to me and I will present you with another [" .. eq.say_link("task") .. "]. Do you seek to craft [" .. eq.say_link("Emerald Novice Gauntlets") .. "], [" .. eq.say_link("Emerald Novice Boots") .. "], an [" .. eq.say_link("Emerald Novice Bracer") .. "], an [" .. eq.say_link("Emerald Novice Helm") .. "], [" .. eq.say_link("Emerald Novice Greaves") .. "], [" .. eq.say_link("Emerald Novice Vambraces") .. "], or an [" .. eq.say_link("Emerald Novice Breastplate") .. "]?");
	...
	elseif(e.message:findi("threats")) then
		e.self:Say("The threats that face Tunares children here in the Faydarks are many, some more obvious than others. The orcish Clan Crushbone has a citadel to the north and is perpetually invading the Faydarks in order to pillage supplies and expand their territory. The foolish pixies that inhabit the forests often cause harm to the trees and animals with their mischievous pranks, and recently the [" .. eq.say_link("Arboreans") .. "] have returned from centuries of slumber.");
