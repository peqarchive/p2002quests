function event_say(e)
	...
	elseif(e.message:findi("about a Erud's Tonic")) then
		e.self:Say("Long ago, the great Erud found that excessive indulgence in spirits led to diminished mental awareness. His love of Kaladim brandy led him to concoct [" .. eq.say_link("have some Erud's Tonic",false,"Erud's Tonic") .. "]. The tonic blocked the effects of all spirits. Unfortunately, it is made from our precious [" .. eq.say_link("Vasty Deep water") .. "] and therefore is not permitted to be exported or given to non-Erudites or adventuring Erudites.");
