...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13876})) then
		...
		e.other:AddEXP(100);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13879})) then -- Pearls of Odus Handin: full bag of pearls
