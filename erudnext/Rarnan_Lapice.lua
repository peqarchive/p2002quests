function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("It is good to meet you. " .. e.other:GetName() .. ".  To enter the Temple of Divine Light is to invite Quellious into your body and soul.  Tranquility is our way and. as such. we do all we can to uphold it.  Are you a [" .. eq.say_link("cleric of Quellious") .. "]. or am I mistaken?");
