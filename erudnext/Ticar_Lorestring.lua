...
function event_say(e)
	...
	elseif(e.message:findi("interested")) then
		e.self:Say("I have messages that need to go to - well, right now I have one that needs to go to Qeynos.  Will you [" .. eq.say_link("deliver mail to Qeynos",false,"deliver") .. "] mail to [" .. eq.say_link("deliver mail to Qeynos",false,"Qeynos") .. "] for me?");
