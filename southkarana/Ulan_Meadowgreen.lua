...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings. I am Ulan Meadowgreen of the family Meadowgreen. My brother and I are the best Armorers in all of Norrath. We craft [" .. eq.say_link("armor") .. "] for the bravest warriors in the land. If you are a Warrior of renown, and are interested in our armor, I have some mighty [" .. eq.say_link("labors") .. "] which you might attempt for me.");
	elseif(e.message:findi("armor")) then
		e.self:Say("I smith [" .. eq.say_link("Bracers") .. "], [" .. eq.say_link("Greaves") .. "], [" .. eq.say_link("Pauldrons") .. "] and [" .. eq.say_link("Breastplates") .. "]. My brother Shakrn smiths Helms, Gauntlets, Boots and Vambraces.");
	...
	elseif(e.message:findi("bracers")) then
		e.self:Say("The fine sheen that you see on our Crafted Armor is produced by a mixture of river berries and juice squeezed from the Optic Nerves of an Evil Eye. We are always in need of more Optic nerves for our armor. Bring me a handful of Optic Nerves and a [" .. eq.say_link("Sapphire") .. "], and I will give you a Crafted Bracer for your trouble.");
	elseif(e.message:findi("greaves")) then
		e.self:Say("Years ago, a Necromancer most foul terrorized the people of the Karanas. This wretch stole a [" .. eq.say_link("circlet") .. "] that father was smithing for my sister. It was very easy to recognize - shining silver like the light of dawn breaking. I have heard rumors that this Necromancer has settled in the depths of Najena. Return this circlet to me and gift me with two [Star Rubies], and I will reward you with Crafted Greaves.");
	...
	elseif(e.message:findi("breastplate")) then
		e.self:Say("Deep within the depths of Castle Mistmoore live a particularly deadly clan of Werewolves. These are the servants of [" .. eq.say_link("Mayong") .. "], and he has enchanted the most ferocious of them that their talons might cut through steel. I wish to study these talons, and see if I can transfer the enchantments from them to the Crafted Armor that I make. If you bring me Werewolf talons and [Rubies], then I will give to you a Breastplate the likes of which you have never before seen.");
