...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hail. I am Shakrn Meadowgreen, Warrior extraordinaire and Master Armorer of the Meadowgreen family. My brother and I craft [" .. eq.say_link("armor") .. "] for the bravest warriors in the land -- do you think you [" .. eq.say_link("qualify") .. "]?");
	elseif(e.message:findi("armor")) then
		e.self:Say("I smith [" .. eq.say_link("Helms") .. "], [" .. eq.say_link("Gauntlets") .. "], [" .. eq.say_link("Boots") .. "] and [" .. eq.say_link("Vambraces") .. "]. My brother Ulan smiths Bracers, Greaves, Pauldruns and Breastplates.");
	elseif(e.message:findi("qualify")) then
		e.self:Say("So you are a warrior of renown?  [" .. eq.say_link("Prove") .. "] it to me and I will smith you [armor] befitting your exalted station.");
	...
	elseif(e.message:findi("helm")) then
		e.self:Say("One of my brethren spoke to me of the mystic properties of the Fire Totems carried by the Goblin High Shaman in Solusek's Eye. My mighty Centaur body will not fit down those twisty goblin passages, so I have not been able to acquire one on my own. As proof of your powers, I ask you to bring me a Fire Totem and one [" .. eq.say_link("Ruby") .. "] stone. Do so and I will reward you with a Crafted Helmet.");
	elseif(e.message:findi("gauntlets")) then
		e.self:Say("Crafted Gauntlets - the mark of a distinguished warrior. I have a personal grudge to settle with those twice-cursed Aviaks. They have been raiding our merchant convoys for the last few weeks, causing mischief to no end. Bring me an Aviak charm from a Avocet - I am sure that you will not need me to tell you how to get it. An Aviak Charm and two [" .. eq.say_link("Star Rubies") .. "], and I will reward you with Crafted Gauntlets.");
	elseif(e.message:findi("boots")) then
		e.self:Say("One of my brethren spoke to me of the mystic properties of the Frost Totems carried by the Goblin High Shamans in Permafrost Keep. I have been unable to fetch one for myself, as my Centaur's body will not fit through the tunnels of those sniveling wretches. Prove your might by gifting me a Frost Totem and two [" .. eq.say_link("Sapphire") .. "] stones. Do this and I will reward you with a pair of Crafted Boots.");
	elseif(e.message:findi("vambraces")) then
		e.self:Say("Come, Warrior, and speak to me of your strength. Bring me the Eye of a Griffon that I might eat it raw in the fashion of my ancestors. Do this for me - then gift me with two [" .. eq.say_link("Fire Emeralds") .. "], and for you I will make a Crafted Vambrace.");
