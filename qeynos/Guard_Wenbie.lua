...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say(string.format("Hello, " .. e.other:GetName() .. ". What brings you to Qeynos? Must be the mighty fine muffins over at [" .. eq.say_link("Voleen's Bakery") .. "]. I just love those muffins!",e.other:GetName()));
