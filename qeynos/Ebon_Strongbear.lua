function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome. I am the champion of the Steel Warriors. There are none who can challenge me. I guide this brotherhood of Steel Warriors. From Qeynos to the trade city of Freeport, the ways of the Steel Warriors are taught. I welcome all [" .. eq.say_link("young Steel Warriors") .. "].");
	elseif(e.message:findi("young steel warrior")) then
		e.self:Say("Then listen well to the words of the trainers of this arena. Learn to aid our friends such as the Knights of Thunder, the Priests of Life, the rangers and druids of Surefall Glade, the monks of the Silent Fist Clan and always support the Qeynos Guards for many of our brothers have entered their ranks. Oh yes.. You can also trust the bards of this city, after all, they do perform at all of our major events. If you are a [" .. eq.say_link("new recruit") .. "] I have some tasks for you to complete.");
	elseif(e.message:findi("new recruit")) then
		e.self:Say("I am always pleased to see new blood ready to serve the Steel Warriors. All new recruits are asked to go through training that I personally oversee. These training exercises will test both your mind body and spirit because they are not easily completed. If you are [" .. eq.say_link("ready to begin") .. "] I will explain to you how the tests work and present you with your Steel Warriors Assembly Kit.");
	elseif(e.message:findi("ready to begin")) then
		e.other:SummonItem(17268);
		e.self:Say("Here is your Steel Warriors Assembly Kit. In this kit you will combine numerous [" .. eq.say_link("magical items") .. "] that can be infused in certain quantities to create an armor material. These armor materials can then be placed in a forge along with the correct mold to fashion a piece of Battlemasters Platemail Armor.");
	elseif(e.message:findi("magical items")) then
		e.self:Say("The items you will need for your armor materials will be collected throughout the Qeynos area. You will find items that you need by hunting and by talking to local merchants. Once you are ready to begin collecting the items for an armor material you must simply tell me what piece you want to craft. I can provide you with the recipes and armor molds for Battlemasters Platemail [" .. eq.say_link("Helm") .. "], [" .. eq.say_link("Bracers") .. "], [" .. eq.say_link("Armguards") .. "], [" .. eq.say_link("Boots") .. "], [" .. eq.say_link("Greaves") .. "], [" .. eq.say_link("Gauntlets") .. "] and [" .. eq.say_link("Breastplate") .. "].");
