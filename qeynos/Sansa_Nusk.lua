function event_say(e)
	...
	elseif(e.message:findi("fabian")) then
		e.self:Say("Ahh - jolly Fabian. He is one of our best customers! That is, of course, due to the fact that he has the heaviest fingers of any bard I know. Anyhow, down to business. I assume he sent you for a new set of strings. Unfortunately, I have not been able to procure any of the [" .. eq.say_link("special things",false,"special") .. "] - uhh - things needed to make his strings lately.");
	elseif(e.message:findi("special things")) then
		e.self:Say("Uhh - ummm - uhhh - Fabian does not know this, but his strings are - uh - made of - uh - [" .. eq.say_link("troll guts") .. "].");
