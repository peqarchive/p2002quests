function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings, friend. My name is Joffrey. I'm trying to learn to play the flute. I'm also working on a new song I learned while I was visiting [" .. eq.say_link("Kelethin") .. "].");
