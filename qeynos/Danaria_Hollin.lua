...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings! Nice to meet someone with manners. I do not see how you people stand to live in this madhouse of ruffians. I would have left weeks ago if I were not waiting for a [" .. eq.say_link("delivery") .. "]. Oh, well. Nice to have met you.");
	elseif(e.message:findi("delivery")) then
		e.self:Say("I am in Qeynos to meet up with a fellow Erudite coming from Freeport. He is two weeks late and I fear the worst. I shall need to hire some lackey to go to Freeport to [" .. eq.say_link("find him") .. "].");
