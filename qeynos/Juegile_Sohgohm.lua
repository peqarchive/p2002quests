...
function event_say(e)
	...
	elseif(e.message:findi("training exercise")) then
		e.self:Say("The training exercises that I have prepared for my recruits are very necessary for the development of ones intellectual and hunting abilities. You will be presented with a Beginners Sewing Kit first, that will be used to combine a number of different [" .. eq.say_link("magical items") .. "] to create an infused armor material. Your material can then be combined in a loom with a pattern that I will present you with to create assorted pieces of Arcane Order Armor.");
	elseif(e.message:findi("magical item")) then
		e.self:Say("The items that are required for your armor materials will come from all areas of Qeynos, including some of our merchants. When you are ready to collect the items for a specific armor piece please tell me what armor piece you [" .. eq.say_link("want") .. "] to craft. I can provide you with the material recipes and applicable patterns for Arcane Order [" .. eq.say_link("Caps") .. "], [" .. eq.say_link("Bracers") .. "], [" .. eq.say_link("Sleeves") .. "], [" .. eq.say_link("Sandals") .. "], [" .. eq.say_link("Trousers") .. "], [" .. eq.say_link("Gloves") .. "] and [" .. eq.say_link("Robes") .. "].");
