...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("If you are a fellow merchant. I must warn you of the inevitable tax increase.  Antonius Bayle is soon to make a [" .. eq.say_link("deal") .. "] with the people of Surefall Glade.");
