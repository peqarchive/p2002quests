function event_say(e)
	...
	elseif(e.message:findi("helps hergor get fatter")) then
		e.self:Say("Yooz makes da good choice.  Me nevers get enuff ta eats.  Eats more and gets more stronger. me always say.  Yooz gos and speaks wit carver Cagrek.  Yooz tell him [" .. eq.say_link("Hergor wants his fungus dung pie") .. "].  Yooz duz dis and me gives you sum rawhide armer or tatters armer.");
	end
end
