function event_say(e)
	...
	elseif (e.message:findi("What next part of my training")) then
...
function event_trade(e)
	...
	elseif (item_lib.check_turn_in(e.self, e.trade, {item1 = 13060})) then
		...
		e.other:Faction(292,10,0);
		e.other:Faction(106,-10,0);
	elseif (item_lib.check_turn_in(e.self, e.trade, {item1 = 22572, item2 = 22572, item3 = 22572, item4 = 22572})) then
