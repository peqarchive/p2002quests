function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hi, do ya likes eatin', or puhaps Hukulk sent ya? I makes many gud eats. Doh, sum I can'ts make cause sum tings I ain't gots. I cud makes some berry tastie stuff wid only [" .. eq.say_link("sum wolf meat") .. "].");
...
function event_trade(e)
	...
	if (item_lib.check_turn_in(e.self, e.trade, {item1 = 13403,item2 = 13403})) then -- Wolf Meat for Wista
