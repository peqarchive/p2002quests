...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 5018,item2 = 13036,item3 = 13036})) then -- Pick and 2x Dwarven Ale
		...
		e.other:QuestReward(e.self,0,0,0,0,6701,500); -- A Dusty Old Leg Bone
	end
