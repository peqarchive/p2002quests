function event_say(e)
	...
	elseif(e.message:findi("control")) then
		e.self:Say("Control. Aye. Break em like dogs or such. Domesticate em. I ain't ever found a way, all I got is me [" .. eq.say_link("theories") .. "].");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 30270,item2 = 30249})) then -- Gem of Persuasion and Blood Wolf Harness
		e.self:Say("Hey! What ya got there? Well now, ain't that pretty! Ya know, this just might do it. You done what I never was able. I gotta give ya that much. I ain't much o' one for travelin' any more. My legs be old and my bones are weak. You take this harness and find a good big mother of a [" .. eq.say_link("wurm") .. "] ta test it on. Just focus in yer mind what yer wantin the wurm ta do. Heh, maybe have it clear out some pests, eh?");
