function event_say(e)
	...
	elseif(e.message:findi("exotic ingredients")) then
		e.self:Say("I desire a [" .. eq.say_link("kiola nut") .. "], [" .. eq.say_link("Erud's Tonic") .. "], [" .. eq.say_link("honey jum") .. "] and a [" .. eq.say_link("Koalindl fish") .. "].  If I could get those. I would no longer need to hold on to the [" .. eq.say_link("Barkeep's Compendium") .. "].  Whoever returned the ingredients to me could have it!!");
