function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("May the rage of Innoruuk flow through your veins. Welcome " .. e.other:GetName() .. ". Soon the Dismal Rage shall run rampant in the streets of Freeport. Our numbers grow. Like you, so many feel the rage within. It is now time to [" .. eq.say_link(" serve Innoruuk ") .. "].");
	elseif(e.message:findi("serve innoruuk")) then
		e.self:Say("Wise choice. We of the Dismal Rage have learned of the value of incompetence. As the Teir'Dal use the ogres and the trolls so to shall the Dismal Rage have A pawn in this game. Ours is the Freeport Militia. They trust us. How unfortunate for them. I want you to go speak with Sir Lucan D'lere, the so called ruler of this city and leader of this mob of ruffians called the Freeport Militia. Tell him you are [" .. eq.say_link(" from the Shrine of Innoruuk ") .. "]. Do as he asks. Little favors lead to large debts. And if you should find something of importance, bring it to me not that inept warrior.");
	end
end
