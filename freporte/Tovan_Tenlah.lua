function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("I suppose you're one of Nestrals new employees, eh? Well if that's the case I can help get you outfitted with some [" .. eq.say_link("gear") .. "] necessary for people in this [line of work].");
