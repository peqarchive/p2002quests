function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("What is it maggot? I have only time for new clerics who have chosen to [" .. eq.say_link("serve the Dismal Rage") .. "]. If you are looking for meaningless banter. than I suggest you find a bar wench.");
