--a_confused_castaway (210461)
--trigger mob for #Jeplak,_Lord_of_Srerendi (210471) LVL 70 version
--postorms (Ocean Giant Fort)
...
function event_say(e)
	...
	elseif e.message:findi("jeplak") then
		...
		eq.unique_spawn(210471,0,0,349,-3163,-455,0);	--#Jeplak,_Lord_of_Srerendi (210471)
		eq.depop();
	end
end
