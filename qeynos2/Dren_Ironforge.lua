function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome to Ironforge's.  We are the makers of all things fine. Would you care to view my wares, or have you come to learn the fine art of crafting [" .. eq.say_link("Antonian Weapons") .. "]?");
	elseif(e.message:findi("Antonian Weapons")) then
		e.self:Say("I teach the process of crafting [" .. eq.say_link("Antonian javelins") .. "] and [" .. eq.say_link("Antonian long swords]") .. "] weapons of superb craftsmanship used by the greatest knights and the personal guards of Antonius Bayle! You'll find nothing like them in all of Norrath since they can only be forged here in Qeynos at the Royal Qeynos forge.");
