function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Pleased to meet you " .. e.other:GetName() .. ". I am Filian Weagleross High Priest of the glorious Rodcet Nife! I have recently taken upon some very [" .. eq.say_link("important duties") .. "] here in our temple so if your business is not urgent please excuse me.");
	elseif(e.message:findi("important duties")) then
		e.self:Say("My important duties are training the new recruits of our temple. It can be quite perilious for a new adventurer in our world today as I am sure you will soon find out. The Temple of Life is dedicated to ensuring that once our young ones leave our home to venture out into Norrath they are ready for whatever might present itself. If you are a [" .. eq.say_link("young cleric of Rodcet") .. "] then we can begin your training at once.");
	elseif(e.message:findi("young cleric of rodcet")) then
		e.self:Say("Your training will be very important to your development as a Cleric of Rodcet Nife so I do hope you will remain focused at all times. Your exercises will take you all over your hunting area and our city to specific [" .. eq.say_link("magical items") .. "].");
	elseif(e.message:findi("magical item")) then
		e.self:Say("The magical items you need to collect will be necessary for creating your magical armor will be placed in this Prime Healers Mail Kit that will create armor materials.When you are ready to collect the items necessary for creating a piece of armor all you must do is tell me what armor piece you want to craft. I can present you with the recipes and armor molds for Prime Healer Initiate [" .. eq.say_link("Helms") .. "], [" .. eq.say_link("Bracers") .. "], [" .. eq.say_link("Armguards") .. "], [" .. eq.say_link("Boots") .. "], [" .. eq.say_link("Greaves") .. "], [" .. eq.say_link("Gauntlets") .. "] and [" .. eq.say_link("Breastplates") .. "].");
