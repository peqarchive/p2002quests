function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say(string.format("Hello. %s. I am Felodius Sworddancer.  A travelling historian and storyteller.  Would you care to hear a [" .. eq.say_link("story") .. "]?",e.other:GetName()));
	elseif(e.message:findi("story")) then
		e.self:Say("I could treat you to a story about an ogre legend!  Or perhaps you would like to hear a story about the [" .. eq.say_link("gnome") .. "] who cried kobold?");
