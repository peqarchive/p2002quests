function event_say(e)
	...
	if(e.message:findi("hail")) then
		e.self:Say(string.format("Hello, %s. I am Sneed Galliway, merchant and citizen. I run the only general store in all of Qeynos, serving the needs of the many adventurers who call Qeynos home. If only one of them would take the time to help me with my er... [" .. eq.say_link("problem") .. "]...",e.other:GetName()));
