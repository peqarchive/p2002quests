function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say(string.format("Greetings. %s. I am Jaylia the Faithful. daughter of Raiston and Launa Lightmist.  I was born in Qeynos while it was under the rule of Antonius Bayle III.  My parents were both paladins of [" .. eq.say_link("Rodcet Nife") .. "] and protectors of the city.  They saw to it that I learned the ways of the [" .. eq.say_link("Holy Knights") .. "].",e.other:GetName()));
	elseif(e.message:findi("holy knights")) then
		e.self:Say("My parents provided me with a vast amount of knowledge.  I was taught the ways of the Holy Knights at the Temple of Thunder and the Temple of Life.  After the death of my father. I was sent to [" .. eq.say_link("Freeport") .. "] to study the holy ways of the Knights of Truth.");
	elseif(e.message:findi("freeport")) then
		e.self:Say("Freeport is a trade city to the east of Qeynos.  A few years after going to Freeport. I received an urgent message from Qeynos.  My mother had taken ill and I was needed in Qeynos immediately.  When I returned home. it was too late.  My mother had passed away due to a plague created by [" .. eq.say_link("heretics") .. "].");
	...
	elseif(e.message:findi("rodcet nife")) then
		e.self:Say("Rodcet Nife is The Prime Healer.  It was he who sent me to take my place in the [" .. eq.say_link("Realm of Heroes") .. "].");
