function event_say(e)
	if (e.message:findi("hail")) then
		e.self:Say("You have pervaded the inner core of the shrine, what brings your corporeal essence this far? Seek you to [" .. eq.say_link("prove my worth",false,"prove your worth") .. "] to the lord and his kin?");
	elseif(e.message:findi("prove my worth")) then
		e.self:Say("So it shall be then that you will perform a task for the kin. As it happens, I was on a mission to speak with a [" .. eq.say_link("contact") .. "] of the shrine in the lands that do not sleep. This contact has vital information on the movements of the giants in that region and it is most important that we recover that information. Unfortunately, I have been called away on duty to further bolster our defenses and will not be able to meet with her.");
