...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 10000, item2 = 10035, item3 = 10035})) then 
		e.self:Say("Here is your prize - a lambent ruby.");
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 2332, item2 = 10553, item3 = 10554, item4 = 10555})) then 
		e.self:Say("You impress me, adventurer! I had not expected you to return with all of the runes. Very well, I shall keep my half of the bargain. Here is your Runescale Cloak.");
		e.other:Faction(320,10,0);
		e.other:Faction(291,-1,0);
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 16507})) then 
		e.self:Say("I see that Gavel has sent you to me.  Very well, I have vulcanized your platinum bar - take it.");
