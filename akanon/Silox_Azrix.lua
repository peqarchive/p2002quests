...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 20694})) then -- Gleaming Unicorn Horn
		...
		e.other:QuestReward(e.self,0,0,0,0,20697,10000);  -- Cleansed Spirit of Faydwer
		eq.depop_with_timer();
	end
