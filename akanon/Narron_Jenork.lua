...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 9111, item2 = 9112, item3 = 9113, item4 = 9114})) then -- Clockwork Oil Extract, Minotaur Tibia, Young Ebon Drake Ribcage and Renegade Clockwork Scrapmetal
		...
		e.other:QuestReward(e.self,0,0,0,0,9115,100); -- Initiate Watchmans Long Sword
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 12378})) then -- Box of Undead Brownies
		...
		e.other:QuestReward(e.self,0,0,0,4,12379,10000); -- Watchman Boots
	end
