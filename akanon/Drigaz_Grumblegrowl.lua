...
function event_trade(e)
	...
	if (item_lib.check_turn_in(e.self, e.trade, {item1 = 1779,item2 = 14585})) then -- Sealed Parchment and Odd Cold Iron Necklace
		...
		e.other:Faction(210,20,0); -- Merchants of Ak'Anon
		e.other:Faction(115,20,0); -- Gem Choppers
		e.other:Faction(71,-20,0); -- Dark Reflection
		e.other:QuestReward(e.self,0,0,0,0,1780,1500); -- Hieroglyph Translations
	end
