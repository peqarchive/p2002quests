function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings, young one. I am Manik Compolten, High Watchman. Are you a [" .. eq.say_link("new warrior") .. "] or an [" .. eq.say_link("experienced fighter") .. "]?");
	elseif(e.message:findi("new warrior")) then
		if(e.other:GetFaction(e.self) < 5) then
			...
			e.other:SummonItem(13844); -- Shiny Card
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13208,item2 = 13208})) then -- 2x Rusted Blackbox
	...
	elseif (item_lib.check_turn_in(e.self, e.trade, {item1 = 13212, item2 = 13211, item3 = 13213, item4 = 13214})) then -- Blackbox XIIC, Blackbox XXVIC, Blackbox XVIIC and Blackbox XXVIIC
		...
		e.other:QuestReward(e.self,0,0,0,0,13209,100); -- Blackbox XXVIIC
	elseif (item_lib.check_turn_in(e.self, e.trade, {item1 = 13215})) then -- Rusted Blackbox
		...
		if(math.random(100) < 20) then
			e.other:QuestReward(e.self,1,3,0,0,eq.ChooseRandom(13219,13220),500); -- Bull Smasher or Ionys Absorber
		else
			e.other:QuestReward(e.self,1,3,0,0,eq.ChooseRandom(1013, 1018, 1015, 1019, 1022, 1023, 1024, 1017, 1016, 1020, 1014, 1021),500); -- Random Cloth
		end		
	end
