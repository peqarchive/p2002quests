function event_say(e)
	...
	elseif(e.message:findi("serve as a cleric")) then
		e.self:Say("We have been blessed by Bertoxxulous with the vision of the Dark Reflection. We are the prophet and protectors of all who serve the Plague Bringer and have devoted our lives to spreading disease and decay for the glory of Bertoxxulous and the balances that must be maintained. Take this parchment to Glerbella Gibblix, she will assist you with the construction of a suit of armor to aid in protecting you from the weapons of those who would see us destroyed. When you have been properly outfitted return to me for your [" .. eq.say_link("next task") .. "].");
		e.other:SummonItem(10989); -- Parchment to Glerbella
...
function event_trade(e)
	...
	if (item_lib.check_turn_in(e.self, e.trade, {item1 = 10993})) then -- Vyntoks Mace
		...
		e.other:QuestReward(e.self,0,0,0,0,11080,100); -- Plague Raiser Mace
	end
