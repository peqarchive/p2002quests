...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 12160, item2 = 12160, item3 = 12160, item4 = 12160})) then -- Basilisk Tongue x 4
		...
		e.other:Faction(71,-30,0); 	-- Dark reflection
		e.other:Faction(322,-30,0); -- the dead
		e.other:QuestReward(e.self,6,1,5,1,eq.ChooseRandom(15205,15211,15288,15310,15311,15313,15331,15050,15093,15315,15316,15058,15317,15318,15036,15094,15246,15322,15323,15325,15851,15324,15332,15400,15399,15398,15042,15613),100); -- mage lvl 1-8 spells excluding pet item spells
