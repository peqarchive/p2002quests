function event_say(e)
	...
	elseif(e.message:findi("important components")) then
		...
		e.other:SummonItem(17256); -- Tinkered Sewing Kit
	...
	elseif(e.message:findi("final tasks")) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 9116, item2 = 9117, item3 = 9118, item4 = 9119})) then -- An Ancient Tome Insert pg1, An Ancient Tome Insert pg2, An Ancient Tome Insert pg3 and An Ancient Tome Insert pg4
		...
		e.other:QuestReward(e.self,0,0,0,0,9120,25); -- Spellbook of the Eldritch Initiate
	end
