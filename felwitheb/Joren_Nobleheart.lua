...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("I hope you have been [" .. eq.say_link("sent by the King") .. "]. There is an urgent matter at hand.");
	elseif(e.message:findi("sent by the king")) then
		e.self:Say("Our sources at the outpost have learned that the Chardokian royal family had a part in the disappearance of Firiona Vie. I have been ordered by King Tearis Thex to locate individuals familiar with the new lands and to order them to the gates of Chardok Mountain. Do you [" .. eq.say_link("accept") .. "] the king's order?");
