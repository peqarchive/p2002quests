...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hail, traveler! You are free to rest within this keep or within any of my towers along the roads to Qeynos. My guards shall keep watch over you. While you tread upon the roads, be warned that there are [" .. eq.say_link("local dangers") .. "] as well as rumors of [" .. eq.say_link("corrupt guards") .. "].");
	...
	elseif(e.message:findi("local dangers")) then
		e.self:Say("My guards report daily to me of dangers in the plains. Lately, they've been telling me of rumors of [" .. eq.say_link("Lord Grimrot") .. "].");
