function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Yes. My bark is blackened and cracked by sickness. If only I were the only one to be afflicted this way. Throughout the lands this is happening. Agents of some [" .. eq.say_link("dark god") .. "] are twisting the lands and their creatures.");
	elseif(e.message:findi("dark god")) then
		e.self:Say("Not long ago, a human passed through this area. Around him swarmed some aura of sickness. Few could see it but with my age I could recognize a bringer of the plague. He seeded the area with pestilence before I could lift a branch to stop him. I believe it was he, and others in other lands, who has helped bring about this [" .. eq.say_link("sickness") .. "].");
