function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings. I am searching for the [" .. eq.say_link("wheel of Tarton") .. "]. If you will assist me I will provide you with [runes] to create a powerful spell.");
