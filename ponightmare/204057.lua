...
function event_say(e)
	...
	elseif e.message:findi("ready") and not started then
		...
		EventReset();
		eq.start(162);	--pathing grid Maze #3
		started = true;
		eq.stop_all_timers();
...
function event_waypoint_arrive(e)
	...
	elseif e.wp == 106 and not construct then
		construct = true;		
		eq.spawn2(204460,0,0,-4550,6118,-5,256) 	-- #a_construct_of_nightmares (Final Encounter)
	end
end
...
function EventReset()
	maze_id = 3;	--for qglobal description
	counter = 0;
	started = false;
	hilt = false;
	shard = false;
...
function spawn_mobs(loc,num)
	local spawn_locs = { [1] = {-4719,6246,4,130}, [2] = {-4758,6086,4,29}, [3] = {-4920,5710,4,100}, [4] = {-4136, 5645, 4,100}, [5] = {-4276,5909,4,100}, [6] = {-4436,6379,4,93} };
	for n = 1,num do
