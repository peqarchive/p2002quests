...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hail to you, friend. If you require assistance, please ask, if not I must return to my [" .. eq.say_link("tasks") .. "].");
	elseif(e.message:findi("tasks")) then
		e.self:Say("It is here that the light shines brightest in our fair city. Here I sit, transcribing scrolls of luminescence. Spells to light the dark, to blind the evil with [" .. eq.say_link("purity") .. "], or to heal those in pain. I find it so much easier to work with such spells if I am in the light itself.");
