function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Well met. " .. e.other:GetName() .. "! I am Tanalin Silverkale, provider of the finest [" .. eq.say_link("mithril ore") .. "] and master craftsman of [mithril chainmail]!");
