function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("I am sorry, young one, but I am too burdened by my own [" .. eq.say_link("troubles") .. "] to help you now. Please seek another of the faith to ease your soul.");
	elseif(e.message:findi("troubles")) then
