...
function event_say(e)
	...
	elseif(e.message:findi("waistband")) then
		e.self:Say("For the waistband of concealment you're going to have to go get me a cloud jewel, a mark of stealth, an engraved platinum statuette, and a true silver needle.");
...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 4491, item2 = 5296, item3 = 5297, item4 = 5298})) then
		e.self:Emote("smiles.");
		e.self:Say("Here is what I promised, ".. e.other:GetName() .. ".");
