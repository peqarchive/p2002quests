function event_say(e)
	...
	elseif(e.message:findi("story")) then
		e.self:Say("I could treat you to a story about an [" .. eq.say_link("ogre legend",false,"ogre") .. "] legend! But perhaps you would like to hear a story about the [" .. eq.say_link("gnome") .. "] that cried kobold?");
