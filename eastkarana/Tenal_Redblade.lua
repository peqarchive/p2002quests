...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 20680,item2 = 10549})) then -- Totem of the Freezing War and Heart of Frost
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 20683,item2 = 20676})) then -- Mark of the Sword and Hand of the Maestro
