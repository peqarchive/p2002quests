...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Please [" .. eq.say_link("help") .. "] me out of this horrid place! My family must be terribly worried!");
	elseif(e.message:findi("help")) then
		e.self:Say("If you can find the [" .. eq.say_link("key") .. "] to my restraints. I should be able to escape.");
