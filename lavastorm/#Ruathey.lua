...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 2417})) then  -- Note to Ruathey
		e.self:Say("I see that you've spoken to Llara. She too came to me looking for Amstaf. Though she wasn't able to find her friend, she was able to recover his [" .. eq.say_link("sword") .. "].");
		e.other:Ding();
