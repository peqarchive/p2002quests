function event_say(e)
	...
	elseif(e.message:findi("ariska zimel")) then
		e.self:Say("Ariska Zimel was a human blacksmith, a master when it came to making swords, I hear. He kept to himself a lot. He disappeared about one year ago. A lot of people were disappointed when we had to [" .. eq.say_link("condemned",false,"condemn") .. "] Zimel's Blades. All the merchandise was handed over to [" .. eq.say_link("Groflah Steadirt") .. "]. Mostly charred junk.");
