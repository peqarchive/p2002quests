function event_say(e)
	...
	elseif(e.message:findi("join the fight")) then
		e.self:Say("You are wise. If you are a paladin, either speak with Theron of this temple or visit the Hall of Truth here in North Freeport. Clerics should concetrate on keeping the knights strong and healthy. Would you care to [" .. eq.say_link("assist the Temple of Marr") .. "]?");
