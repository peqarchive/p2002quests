...
function event_say(e)
	if(e.message:findi("hail")) then -- Part of Shaman Epic 1.0
		e.self:Say("Greetings, ".. e.other:Class() .. " . Tell me, do you follow [" .. eq.say_link("I follow Justice", false, "Justice") .. "], [" .. eq.say_link("I follow War", false, "War") .. "], [" .. eq.say_link("I follow Honor",false,"Honor") .. "], [" .. eq.say_link("I follow Fear",false,"Fear") .. "], or [" .. eq.say_link("I follow Hate",false,"Hate") .. "]?");
	...
	elseif(e.message:findi("i follow fear")) then -- Part of Shaman Epic 1.0
		e.self:Say("While I do not agree with how you go about your existence, we do [" .. eq.say_link("trust") .. "] that your place in the whole is important. You may think that you enslave and command us with the powers the gods grant you, but we are aware of your intentions and accept them. You are a hunter and the spirits are your prey. However, there are times when we, the [" .. eq.say_link("true spirits") .. "] and those like you, can work together to achieve goals, whether mutual or not. Some help us willingly and some we make deals with. Regardless of the intention, these special individuals are known as [" .. eq.say_link("Heyokah") .. "].");
	...
	elseif(e.message:findi("path of the Heyokah")) then -- Part of Shaman Epic 1.0
