function event_say(e)
	...
	elseif(e.message:findi("searching for the fugitive")) then
		e.self:Say("Searching for someone, eh?  You will most likely never find them on the plains.  This is a vast area.  I could have Frostbite help you search.  He is quite good at [" .. eq.say_link("tracking prey") .. "].");
