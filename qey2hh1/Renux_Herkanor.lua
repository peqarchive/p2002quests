...
function event_say(e)
	...
	elseif(e.other:GetFaction(e.self) < 3 and e.other:HasItem(24072)) then
		e.self:Say("You have everything? What are you waiting for?");
	else
...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) < 3) then
		if(item_lib.check_turn_in(e.self, e.trade, {item1 = 24072})) then
			...
			e.other:Faction(36,-1); -- Guards of Qeynos
