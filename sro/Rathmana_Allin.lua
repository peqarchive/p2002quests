function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Company?! Way out here in the desert of Ro? This is a pleasant surprise! Won't you stay for a while? I am sure the desert has dried your throat. I have supplies if necessary. At a price, of course. Are you [" .. eq.say_link("traveling") .. "] or are you here on [" .. eq.say_link("business") .. "]?");
