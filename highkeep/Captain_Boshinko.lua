function event_say(e)
	...
	elseif(e.message:findi("bounty hunter you requested")) then
		e.self:Say("It is about time.  I have been waiting for you for ages!  Your [" .. eq.say_link("reputation") .. "] precedes you.");
	elseif(e.message:findi("reputation")) then
		e.self:Say(string.format("You humor me. %s!  I would have guessed someone like yourself would have little time for humor.  Nevertheless. would you [" .. eq.say_link("like to hear about the job") .. "] I have for you?",e.other:GetName()));
