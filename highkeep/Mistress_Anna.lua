function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Yes? I don't often converse with the servants of Highkeep, but what do you want? I am a very good friend of [" .. eq.say_link("Carson McCabe's") .. "]. If I wished it so, you could be sent to the dungeons to converse with the artisans of pain.");
	...
	elseif(e.message:findi("princess lenya")) then
		e.self:Say("What do you know of the Princess? Are you [" .. eq.say_link("working for Lady McCabe") .. "] or were you [" .. eq.say_link("sent by someone else") .. "]?");
