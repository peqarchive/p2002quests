function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("I'm Captain Bosec. and I am the officer in charge down here. It's my job to patrol the prison and try to keep any [" .. eq.say_link("goblins") .. "] from getting into Highpass.");
	elseif(e.message:findi("goblin")) then
		e.self:Say("Help us exterminate these vile creatures. They call themselves the [" .. eq.say_link("Pickclaw") .. "] Clan.. I call them annoying. I will gladly pay big money for the left ear of every goblin slain.");
