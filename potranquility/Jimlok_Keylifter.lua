...
function event_trade(e)
	local item_lib = require("items");
  	if (item_lib.check_turn_in(e.self, e.trade, {item1 = 28277})) then	--Requires Tiny Bottle and Note
		...
		e.other:QuestReward(e.other,0,0,0,0,28278,100000);	--Reward: Strange Jewelers Schematic
	end
