--Hrelic_Reista (203364)
--Wizard Spell: Draught of Lightning Quest
--potranquility

function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Emote("glances over from his books for a moment. 'Greetings. Have you come to the realm of the tranquil to study as have? The chaotic energy of lightning has caught my interest of late. I've been trying to understand the magics that further refine my control of lightning and [" .. eq.say_link("thunder") .. "].");
...
function event_trade(e)
	local item_lib = require("items");
  	if (item_lib.check_turn_in(e.self, e.trade, {item1 = 9430, item2 = 28445})) then	--Lightning Sphere & Spell: Draught of Thunder
		e.self:Emote("takes the sphere and the scroll from you and begins to scrawl some rune on the bottom of the parchment. He begins to utter some strange syllables over the parchment and the sphere begins to glow, then it dissolves into floating strands of ethereal energy and begins to scrawl itself across the page. Hrelic hands you the scroll, 'The power of lightning rests in your hands " .. e.other:GetName() .. ". Use this new power wisely.'");
		e.other:QuestReward(e.other,0,0,0,0,1119,10000);	--Spell: Draught of Lightning
	end
